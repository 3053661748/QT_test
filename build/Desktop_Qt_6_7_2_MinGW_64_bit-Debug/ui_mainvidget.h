...
""));
        ...
        syq->setFont(font);
        syq->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
...
"background-color:rgba(255,255,255,50);"));
        ...
        bf->setFont(font);
        bf->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
...
"background-color:rgba(255,255,255,50);"));
        ...
        xyq->setFont(font);
        xyq->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
...
"background-color:rgba(255,255,255,50);"));
        ...
        dqxh->setFont(font);
        dqxh->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
...
"background-color:rgba(255,255,255,50);"));
        ...
        layoutWidget->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
...
"}"));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/new/prefix1/img/gy.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        about->setIcon(icon);
        ...
        pf->setObjectName("pf");
        pf->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
...
"}"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/new/prefix1/img/pf.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        pf->setIcon(icon1);
...
"}"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/new/prefix1/img/gb.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        gb->setIcon(icon2);
        ...
        jindutiao->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
...
""));
        ...
        yinliang->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
